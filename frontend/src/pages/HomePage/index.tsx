...
const HomePage = () => {
  return (
    <HomePageContainer>
      ...
      <p>
        Essa é a minha solução para o desafio da vaga de Desenvolvedor Fullstack
        Junior 2 na Softmakers!
      </p>
      <h2>Back-end</h2>
      <p>
        O Back-end da aplicação foi desenvolvido utilizando{' '}
        <strong>
          NodeJS, TypeScript, ExpressJS, Express-Validator, TypeORM e PostgreSQL
        </strong>{' '}
        como banco de dados.
      </p>
      <h2>Front-end</h2>
