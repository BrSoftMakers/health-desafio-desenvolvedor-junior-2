...
const createPetService = ({ name, age, type, breed, owner_id, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield ownerRepository.save(createOwnerPet);
    ...
    yield petRepository.save(createPet);
    return createPet;
});
exports.default = createPetService;
//# sourceMappingURL=createPets.service.js.map